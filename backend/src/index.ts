...
import pageCategoriesRoutes from './routes/pageCategories';
...
const limiter = rateLimit({
  ...
  max: process.env.NODE_ENV === 'production' ? 1000 : 1000, // Higher limit for development
...
app.use('/api/page-categories', pageCategoriesRoutes);
